...
export async function sendRideNotificationToDriver(
  ...
  if (rideDetails.distance) data.distance = rideDetails.distance.toString();
  if (rideDetails.estimatedEarnings) data.estimatedEarnings = rideDetails.estimatedEarnings.toString();
